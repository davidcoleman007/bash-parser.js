...
Deno.test('simple command with prefixes and name', () => {
...
Deno.test('simple command with only name', () => {
...
Deno.test('simple command with pipeline', () => {
...
Deno.test('simple command with suffixes', () => {
...
Deno.test('simple command with IO redirection', () => {
...
Deno.test('simple command with numbered IO redirection', () => {
...
Deno.test('simple command with suffixes & prefixes', () => {
