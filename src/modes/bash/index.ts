import type { Mode, ModePlugin, ParameterOp } from '~/types.ts';
import bashAliasSubstitution from './rules/alias-substitution.ts';

const name = '[a-zA-Z_][a-zA-Z0-9_]*';

const parameterOperators: Record<string, ParameterOp> = {
