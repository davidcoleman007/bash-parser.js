import type { Expansion, Mode, Reducer, ReducerLocation, Reducers, ReducerStateIf } from '~/types.ts';
...
const tokenizer: Mode['tokenizer'] = (r) => (function* tokenizer(src: string) {
	r = r || reducers;
